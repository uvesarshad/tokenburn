...
2. Clone and install: `git clone https://github.com/uvesarshad/tokenburn.git && cd tokenburn && npm link`
...
5. Tell them where the PNG was saved and open it for them. The card is ready to post.
